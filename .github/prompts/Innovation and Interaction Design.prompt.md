...
All work in this iteration must comply with the **Innovation & Interaction Design** and **Data Authority & Dataset Integrity (MANDATORY)** section and general practices in `copilot-instructions.md` and must remain consistent with the project’s conceptual framework in `Dok/context.md`, specifically:
