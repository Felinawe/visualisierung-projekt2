...
All work in this iteration must comply with the **Understanding & Correctness** section and general practices in `copilot-instructions.md` and must remain consistent with the project’s conceptual framework in `Dok/context.md`, specifically:
