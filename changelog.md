...
- Referenzen auf die umbenannten Dateien in `index-baseline.html`, `.github/copilot-instructions.md` sowie in den Prompt-Dateien unter `.github/prompts/` auf die neuen Namen aktualisiert.
- Interne Dokumentüberschrift in `Dok/context.md` auf `context.md` angepasst.
